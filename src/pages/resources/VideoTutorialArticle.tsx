  ...
  const videos = [
    {
      ...
      learningObjectives: [
        ...
        "Temel ajan ayarlarını yapılandırma",
    ...
    },
    {
      ...
      fullDescription: "Temel ajan oluşturmayı öğrendikten sonra, ajanınızı daha da güçlü hale getirmek için gelişmiş yapılandırma seçeneklerini keşfedin. Bu video, özel komutlar, gelişmiş doğal dil işleme ayarları ve performans optimizasyonu konularını kapsar.",
      duration: "15:47",
      ...
      videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
      learningObjectives: [
        "Gelişmiş ajan yapılandırma seçenekleri",
        "Özel komutlar ve tetikleyiciler oluşturma",
        "Performans optimizasyonu teknikleri",
        "Ajan davranışlarını özelleştirme"
      ],
      prerequisites: [
        "Temel Nonplo bilgisi",
        "En az bir ajan oluşturmuş olmak"
      ],
      relatedVideos: ["1", "4", "8"]
    },
    {
