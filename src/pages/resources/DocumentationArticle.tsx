  ...
  const sections = [
    {
      ...
      icon: Rocket,
      articles: [
        { title: "Nonplo'ya Hoş Geldiniz", lastUpdated: "2024-01-15", content: "Nonplo ile yapay zeka ajanı oluşturmanın temellerini öğrenin.", fullContent: "Nonplo, herkesin kolayca yapay zeka ajanları oluşturabileceği bir platformdur. Bu döküman ile platformumuzun temel özelliklerini ve nasıl kullanacağınızı öğreneceksiniz.\n\nNonplo'nun sunduğu temel özellikler:\n• Kodsuz yapay zeka ajanı oluşturma\n• Çoklu dil desteği\n• Gerçek zamanlı analitik\n• Kolay entegrasyon seçenekleri\n\nBu rehber ile adım adım ilk ajanınızı oluşturmaya başlayabilirsiniz." },
        { title: "İlk Ajanınızı Kurma", lastUpdated: "2024-01-12", content: "İlk yapay zeka ajanınızı oluşturmak için adım adım rehber.", fullContent: "İlk ajanınızı oluşturmak için şu adımları takip edin:\n\n1. Hesabınıza giriş yapın\n2. 'Yeni Ajan Oluştur' butonuna tıklayın\n3. Ajanınızın amacını belirleyin\n4. Temel ayarları yapılandırın\n5. Test edin ve yayınlayın\n\nHer adımda size rehberlik edecek detaylı açıklamalar bulacaksınız." },
